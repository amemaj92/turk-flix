			...
			<form action="'.$Sort.'" method="POST">
			  <input type="hidden" name="Req_Type" value="advanced_search">
			    <fieldset>
					...
					<input type="text" id="titulli" name="Title" placeholder="Sadece Sen">
					</li>
					...
					<input type="text" id="vitet" name="Years" placeholder="2012">
					</li>
